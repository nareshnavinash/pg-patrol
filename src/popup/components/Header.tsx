    ...
    <div className="pb-3 border-b border-gray-200 dark:border-gray-700">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className={`relative w-8 h-8 flex items-center justify-center ${enabled ? 'shield-pulse' : ''}`}>
            ...
            <span className="absolute inset-0 flex items-center justify-center text-white font-bold text-[9px]" style={{ paddingBottom: '2px' }}>
              PG
            </span>
          </div>
          <div>
